...
<div class="bg-#EFEFEF mb-20 h-200 lg:h-400 relative">
  ...
  <h2 class="text-center p-10 text-18 lg:text-32 font-700">
    Interested? Let’s talk.
        ...
        <div class="f-c-c">
      <CButton class="mt-10 lg:mt-20"><span class="text-18 lg:text-20 font-700 text-center">How it works</span></CButton>
    </div>
     <img :src="coin1" class="absolute bottom-0  w-120 h-150 lg:w-300 lg:h-300">
    <img :src="coin2" class="absolute top-0 right-0 w-120 h-120 lg:w-300 lg:h-300"> 
  </div>
</div>
</template>